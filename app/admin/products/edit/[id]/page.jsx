      ...
      try {
        ...
        setFormData({
          ...
          shipping: {
            ...
            insideDhakaCharge: product.shipping?.insideDhakaCharge?.toString() || "70",
            outsideDhakaCharge: product.shipping?.outsideDhakaCharge?.toString() || "120",
        ...
        if (product.hasVariations) {
          ...
          setVariants(product.variants.map(v => ({
            ...
            imagesPreviews: v.images?.map(img => `${process.env.NEXT_PUBLIC_API_URL}${img}`) || [],
          })))
        }
      } catch (err) {
      ...
      <form onSubmit={handleSubmit} className="bg-card rounded-2xl shadow-xl border border-border overflow-hidden">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <div className="p-4 md:p-8">
            ...
            <TabsContent value="images" className="mt-0 outline-none"><ImageSection formData={formData} handleChange={handleChange} existingImages={existingImages} removeExistingImage={removeExistingImage} handleNewImagesChange={handleNewImagesChange} newImagesPreviews={newImagesPreviews} removeNewImage={removeNewImage} /></TabsContent>
